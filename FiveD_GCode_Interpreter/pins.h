...
#define POWER_SUPPLY_PIN (byte)14
...
18=ANALOG4=
...
21=opto endstop A ( hardware interrupt pin)
20=opto endstop B ( hardware interrupt pin)
19= DC ENCODER wheel interrupt ( hardware interrupt pin)
